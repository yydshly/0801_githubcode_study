...
| 08 | [Infinite Build 与《孤潮余生》](./research-todos/infinite-build-game-research/) | [The Infinite Build](https://the-infinite-build.openai.chatgpt.site/#start) 工作流参考 · 四游戏能力实验室 · 荒岛案例 | 四个真实案例的机制与视觉生产能力如何形成成品感，以及 2D/2.5D 与实时 3D 的资源差异 | 研究进行中 · R7视觉切片与路线总结 | [打开能力实验室](https://yydshly.github.io/0801_githubcode_study/projects/infinite-build-lab/capability-lab.html#visual-routes) | [项目说明](./research-todos/infinite-build-game-research/README.md) |
...
> 状态：**阶段归档**。当前版本作为可运行研究样例保留，后续只在出现明确产品场景时按需重启。

**[打开在线演示](https://yydshly.github.io/0801_githubcode_study/projects/glass-worlds-gallery/)** · [打开原始参考](https://www.happyoyster.com/home) · [查看演示对比](./glass-worlds-gallery/DEMO_COMPARISON.md) · [查看阶段归档](./glass-worlds-gallery/ARCHIVE.md) · [进入子项目目录](./glass-worlds-gallery/)

这是对 Happy Oyster 式“星系中的球中世界”视觉的可运行拆解。当前版本不依赖世界模型、视频生成服务或专用 token，而是用 React、Three.js 和本地图片构建持久 WebGL 星系：8 个星球由曲面受光的图片纹理内球、双层光学玻璃壳、环境反射和动态高光组成；4 个球使用真实世界空间通道，4 个球保留屏幕导演轨迹，全部按四象限连续离场。背景使用 1,790 个固定屏幕尺寸、全视锥均匀散布的圆形 GPU 星尘粒子。
...
- **资产策略**：当前使用 8 张已经离线生成并压缩的专用 WebP 场景图；后续可以替换图片、视频、全景图或实时流，不需要重写球体和交互外壳。
...
│  ├─ ARCHIVE.md                     # 阶段结论、适用场景与完整后续清单
│  ├─ DEMO_COMPARISON.md             # 原始参考与本地演示关联
...
| 08 · Infinite Build 与《孤潮余生》 | [项目总览](./research-todos/infinite-build-game-research/README.md) | [四游戏视觉路线](./research-todos/infinite-build-game-research/infinite-build-lab/FOUR_GAME_VISUAL_IMPLEMENTATION_SUMMARY.md) · [出生海滩验证](./research-todos/infinite-build-game-research/infinite-build-lab/ARRIVAL_BEACH_VISUAL_SLICE_VALIDATION.md) · [四游戏能力验证](./research-todos/infinite-build-game-research/infinite-build-lab/FOUR_GAME_CAPABILITY_LAB_VALIDATION.md) | [视觉切片契约](./research-todos/infinite-build-game-research/infinite-build-lab/ARRIVAL_BEACH_VISUAL_SLICE_CONTRACT.md) · [生产阻塞](./research-todos/infinite-build-game-research/castaway-island-survival/docs/09_PRODUCTION_DECISION_AND_BLOCKERS.md) | [打开视觉路线总结](https://yydshly.github.io/0801_githubcode_study/projects/infinite-build-lab/capability-lab.html#visual-routes) |
