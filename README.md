...
| 08 | [Infinite Build 与《孤潮余生》](./research-todos/infinite-build-game-research/) | [The Infinite Build](https://the-infinite-build.openai.chatgpt.site/#start) 工作流参考 · 本仓库原创荒岛案例 | 长期 AI 开发方法能否从检查点循环推进到写实游戏，以及真正的资产、驱动和成本边界在哪里 | 研究待办 · 暂缓 | [打开研究与演示](https://yydshly.github.io/0801_githubcode_study/projects/infinite-build-lab/) | [归档说明](./research-todos/infinite-build-game-research/README.md) |
...
| 08 · Infinite Build 与《孤潮余生》 | [归档总览](./research-todos/infinite-build-game-research/README.md) | [方法验证](./research-todos/infinite-build-game-research/infinite-build-lab/VALIDATION.md) · [游戏验证](./research-todos/infinite-build-game-research/castaway-island-survival/VALIDATION.md) | [生产阻塞](./research-todos/infinite-build-game-research/castaway-island-survival/docs/09_PRODUCTION_DECISION_AND_BLOCKERS.md) · [恢复计划](./research-todos/infinite-build-game-research/castaway-island-survival/docs/10_UNREAL_BENCHMARK_PLAN.md) | [Research 08](https://yydshly.github.io/0801_githubcode_study/projects/infinite-build-lab/) |
